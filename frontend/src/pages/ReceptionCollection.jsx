...
function ReceptionCollection() {
  const { products, addToCart, toggleWishlist, wishlist } = useLuxe();

  const filtered = products.filter(prod => prod.occasions && prod.occasions.includes("Reception Elegance"));
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12">
      <div className="text-center mb-12 space-y-2">
        ...
        <p className="text-slate-400 text-sm max-w-lg mx-auto font-light pt-2">Modern high-fashion statement jewelry sets to elevate your evening reception look.</p>
      </div>
