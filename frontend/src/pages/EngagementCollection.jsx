...
function EngagementCollection() {
  ...
  const filtered = products.filter(prod => prod.occasions && prod.occasions.includes("Engagement Vault"));
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12">
      <div className="text-center mb-12 space-y-2">
        ...
        <p className="text-slate-400 text-sm max-w-lg mx-auto font-light pt-2">Make your engagement memories eternal with high-carat diamond rings and tiaras.</p>
      </div>
