...
function Header() {
  ...
  const { wishlist, categories, occasions, cultures, festivals, user } = useLuxe();
    ...
    <header className="sticky top-0 z-50 glass-panel border-b border-gold-500/10 text-slate-100">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-5 text-slate-300">
          <Link to="/wishlist" className="hover:text-luxury-gold transition-colors relative" title="Wishlist Vault">
